...
public abstract class NetworkBoundResource<ResultType extends java.lang.Object, RequestType extends java.lang.Object> {
    ...
    private kotlinx.coroutines.flow.Flow<? extends com.next.up.code.core.data.Resource<ResultType>> result;
    ...
    kotlin.coroutines.Continuation<? super kotlinx.coroutines.flow.Flow<? extends com.next.up.code.core.data.api.network.ApiResponse<? extends RequestType>>> $completion);
    ...
    @org.jetbrains.annotations.NotNull
    public final kotlinx.coroutines.flow.Flow<com.next.up.code.core.data.Resource<ResultType>> asFlow() {
        return null;
    }
}